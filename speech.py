...
def start_polly_synthesis_task(engine="neural", region='ap-northeast-1', endpoint_url='https://polly.ap-northeast-1.amazonaws.com/', output_format='mp3', 
...
def tts(engine="neural", region='ap-northeast-1', endpoint_url='https://polly.ap-northeast-1.amazonaws.com/', output_format='mp3', 
bucket_name='podcast-wellness-e1', s3_key_prefix='prueba', voice_id='Ruth', text_file_path='./input.txt'):
    task_id = start_polly_synthesis_task(engine, region, endpoint_url, output_format, bucket_name, s3_key_prefix, voice_id, text_file_path)
    ...
    print(f'Successfully downloaded the output audio to: ./output.mp3')
    return None
